...
export default function Portfolio() {
  ...
  return (
    <div className="font-sans antialiased overflow-x-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-gray-100 min-h-screen transition-colors duration-300">
      <a
        href="#main-content"
      ...
      <header
        className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl border-b transition-all duration-300 border-gray-800/50 bg-gray-950/80"
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="relative">
              <button
                ...
                className="p-2.5 rounded-xl transition-all duration-200 bg-gray-800 hover:bg-gray-700"
              ...
              {mobileMenu && (
                <motion.div 
                  ...
                  className="absolute right-0 top-full mt-2 w-44 sm:w-48 rounded-xl shadow-xl border overflow-hidden bg-gray-900 border-gray-800"
                >
                  ...
                  <div className="border-t border-gray-800">
                    <a
                      ...
                      download
                      className="flex items-center gap-2 w-full px-4 py-3 text-sm font-semibold transition-all duration-200 text-indigo-400 hover:bg-gray-800"
                    >
      ...
      <main className="pt-14 sm:pt-16 md:pt-20" id="main-content" tabIndex={-1} aria-label="Main content">
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 -right-16 sm:-right-32 w-48 h-48 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full blur-3xl opacity-10 sm:opacity-15 bg-indigo-600" />
            <div className="absolute bottom-1/4 -left-16 sm:-left-32 w-48 h-48 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full blur-3xl opacity-10 sm:opacity-15 bg-purple-600" />
          </div>
            ...
            <div className="text-center space-y-6 sm:space-y-8">
              ...
              >
                <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  <span className="text-white">Yadla Sunny</span>
                </h1>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 15 }}
              ...
              >
                <h2 className="text-lg sm:text-2xl md:text-3xl font-semibold text-indigo-400">
              ...
              <motion.p 
                ...
                className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed text-gray-400"
              >
              ...
              >
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="flex items-center gap-2 p-3 sm:px-4 sm:py-2.5 rounded-full transition-all duration-200 min-w-[48px] min-h-[48px] justify-center text-gray-400 hover:text-white hover:bg-gray-800/80"
                  aria-label="GitHub"
                >
                  <FaGithub size={24} />
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="flex items-center gap-2 p-3 sm:px-4 sm:py-2.5 rounded-full transition-all duration-200 min-w-[48px] min-h-[48px] justify-center text-gray-400 hover:text-blue-400 hover:bg-blue-500/10"
                  aria-label="LinkedIn"
                >
                  <FaLinkedin size={24} />
                ...
                <a 
                  ...
                  className="flex items-center gap-2 p-3 sm:px-4 sm:py-2.5 rounded-full transition-all duration-200 min-w-[48px] min-h-[48px] justify-center text-gray-400 hover:text-red-400 hover:bg-red-500/10"
                  aria-label="Email"
                >
          ...
          >
            <button 
              ...
              className="p-3 rounded-full transition-all duration-200 text-gray-500 hover:text-gray-300 hover:bg-gray-800/50"
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            <motion.div 
              ...
              className="group p-5 sm:p-6 md:p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl border-gray-800/50 bg-gray-900/50 hover:border-indigo-500/30"
            >
              <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl mb-4 sm:mb-5 bg-indigo-500/10">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="group p-6 sm:p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl border-gray-800/50 bg-gray-900/50 hover:border-indigo-500/30"
            >
        ...
        <section
          ref={sections.skills}
          data-section="skills"
          className="py-12 sm:py-16 md:py-24 bg-gray-900/30"
        >
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-3 text-sm sm:text-base max-w-2xl mx-auto text-gray-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              <motion.div
                ...
                className="rounded-xl border p-4 sm:p-6 border-gray-800 bg-gray-900/60"
              >
          ...
          <div className="grid gap-4 sm:gap-5 md:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {filteredProjects.map((p, index) => (
              ...
              >
                ...
                <p className="text-sm leading-relaxed mb-6 flex-1 text-gray-400">
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <ol className="relative border-l-2 border-indigo-500/30 ml-1 sm:ml-2 md:ml-4">
              ...
              >
                ...
                <div className="p-4 sm:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30">
                  <h3 className="font-semibold text-base sm:text-lg">Avanthi Institute of Engineering and Technology</h3>
                  <time className="block mt-1 mb-2 text-xs sm:text-sm font-medium text-indigo-400">B.Tech in Computer Science — Oct 2022 – Jul 2025</time>
                  <p className="text-sm text-gray-400">Focused on algorithms, data structures, and distributed systems projects.</p>
                </div>
              </motion.li>
              ...
              >
                ...
                <div className="p-4 sm:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30">
                  ...
                  <time className="block mt-1 mb-2 text-xs sm:text-sm font-medium text-indigo-400">Diploma in Electronics & Communication Engineering — Jun 2019 – Jun 2022</time>
                  <p className="text-sm text-gray-400">Completed diploma coursework with practical labs in embedded systems and signals.</p>
                </div>
              </motion.li>
              ...
              >
                ...
                <div className="p-4 sm:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30">
                  ...
                  <time className="block mt-1 mb-2 text-xs sm:text-sm font-medium text-indigo-400">Secondary School Certificate — Jun 2013 – Jun 2019</time>
                  <p className="text-sm text-gray-400">Completed secondary education with emphasis on math and science.</p>
                </div>
              </motion.li>
            </ol>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <motion.div
              ...
              className="group p-5 sm:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 bg-orange-500/10">
              ...
              <div className="inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-full bg-orange-500/10 text-orange-400">
            ...
            <motion.div
              ...
              className="group p-5 sm:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 bg-blue-500/10">
              ...
              <div className="inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-full bg-blue-500/10 text-blue-400">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                Certified
        ...
        >
          ...
          <div className={`grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 ${
            ...
            <motion.div 
              ...
              className="space-y-6"
            >
              <div className="p-4 sm:p-5 rounded-xl bg-gray-800/50">
                <h3 className="font-semibold mb-4 text-base sm:text-lg">Contact Information</h3>
                <ul className="space-y-4 text-sm sm:text-base">
                  <li className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-indigo-500/10">
                    ...
                    <a
                      href="mailto:yadlasunny143@gmail.com"
                      className="hover:text-indigo-500 transition-colors text-gray-300"
                    >
                      yadlasunny143@gmail.com
                    </a>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-blue-500/10">
                  ...
                  <li className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-gray-700">
            ...
            >
              <div className="flex flex-col gap-1.5">
                <label htmlFor="from_name" className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-400">Name</label>
                <input
                  id="from_name"
                  required
                  name="from_name"
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="from_email" className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-400">Email</label>
                <input
                  id="from_email"
                  required
                  type="email"
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="message" className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-gray-400">Message</label>
                <textarea
                  id="message"
                  required
                  name="message"
        ...
        <section className="py-12 sm:py-16 md:py-24 bg-gray-900/30">
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="p-5 sm:p-6 md:p-8 rounded-2xl border relative bg-gray-900/80 border-gray-800/50"
              >
                <div className="absolute -top-2 sm:-top-3 left-4 sm:left-6 text-4xl sm:text-5xl text-indigo-500/20">“</div>
                <p className="italic text-sm sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-6 text-gray-300">"Yadla Sunny is a fantastic developer who delivers on time and with quality."</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-500">Manager at Example Corp</div>
                  </div>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <div className="absolute -top-2 sm:-top-3 left-4 sm:left-6 text-4xl sm:text-5xl text-indigo-500/20">“</div>
                <p className="italic text-sm sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-6 text-gray-300">"Great attention to detail and always ready to help the team."</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-500">Co-Founder of NirvionX</div>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            <motion.article 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="group p-5 sm:p-6 md:p-8 rounded-2xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30"
            >
              <div className="inline-block px-2.5 sm:px-3 py-1 rounded-full text-xs font-medium mb-3 sm:mb-4 bg-indigo-500/10 text-indigo-400">React</div>
              ...
              <p className="text-sm sm:text-base mb-3 sm:mb-4 text-gray-400">Tips for scalable folder structure and code organization.</p>
              <a href="#" className="inline-flex items-center gap-2 text-sm font-medium transition-colors text-indigo-400 hover:text-indigo-300">
                Read more
            ...
            <motion.article 
              ...
              className="group p-5 sm:p-6 md:p-8 rounded-2xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-gray-900/80 border-gray-800/50 hover:border-indigo-500/30"
            >
              <div className="inline-block px-2.5 sm:px-3 py-1 rounded-full text-xs font-medium mb-3 sm:mb-4 bg-purple-500/10 text-purple-400">Performance</div>
              ...
              <p className="text-sm sm:text-base mb-3 sm:mb-4 text-gray-400">Memoization, lazy loading, and best practices.</p>
              <a href="#" className="inline-flex items-center gap-2 text-sm font-medium transition-colors text-indigo-400 hover:text-indigo-300">
                Read more
                <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </a>
      ...
      <footer className="py-6 sm:py-8 md:py-12 pb-28 sm:pb-12 border-t border-gray-800/50 bg-gray-950/50">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/Yadlasunny" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg transition-all duration-200 bg-gray-800 text-gray-400 hover:text-white hover:bg-gray-700">
                <FaGithub size={18} />
              </a>
              <a href="https://linkedin.com/in/yadla-sunny" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg transition-all duration-200 bg-gray-800 text-gray-400 hover:text-blue-400 hover:bg-gray-700">
                <FaLinkedin size={18} />
              </a>
              <a href="https://twitter.com/your-handle" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg transition-all duration-200 bg-gray-800 text-gray-400 hover:text-sky-400 hover:bg-gray-700">
                <FaTwitter size={18} />
              </a>
            </div>
          </div>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/70 backdrop-blur-sm" onClick={closeModal}>
          <motion.div
            ...
            className="w-full sm:max-w-lg max-h-[85vh] sm:max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl shadow-2xl p-5 sm:p-6 md:p-8 relative bg-gray-900 border border-gray-800"
            onClick={e => e.stopPropagation()}
          >
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-white"
              aria-label="Close"
            >
            ...
            <div className="flex items-start justify-between gap-3 mb-4">
              ...
              <button
                ...
                className={`flex-shrink-0 p-2 rounded-lg transition-all duration-200 ${
                  favorites.includes(selectedProject.id) ? "bg-red-500/10 text-red-500" : "bg-gray-800 text-gray-400"
                } hover:scale-105`}
              >
                {favorites.includes(selectedProject.id) ? <FaHeart size={16} /> : <FaRegHeart size={16} />}
              </button>
            </div>
            <div className="mb-5 text-sm sm:text-base text-gray-300">{selectedProject.description}</div>
            <div className="flex flex-wrap gap-2 mb-6">
              {selectedProject.tech.map(t => (
                <span key={t} className="text-xs sm:text-sm font-medium px-3 py-1.5 rounded-lg bg-indigo-500/10 text-indigo-400">{t}</span>
              ))}
            </div>
            <div className="flex gap-3">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex-1 py-3 rounded-xl font-semibold text-center text-sm sm:text-base transition-all duration-200 bg-gray-800 text-gray-100 hover:bg-gray-700"
              >
                View Code
              </a>
            </div>
      ...
      {toast && (
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: 20 }}
          className="fixed bottom-6 right-6 px-5 py-3 rounded-xl shadow-lg z-50 bg-gray-800 text-gray-100"
        >
          {toast}
        </motion.div>
      )}
